      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/l_w_7",
                   'caption'=>'My Ch : @hunterteam67',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'اضافة حساب ☃️','callback_data'=>'login']],
                       [['text'=>"Dev", 'url'=>"https://t.me/l_w_7"]],
                      ]
                  ])
              ]);   
          } 
if($text == '/help'){
              ...
              'caption'=>'طرق السحبب🤘😂',
                      'reply_markup'=>json_encode([
                      'inline_keyboard'=>[                       
                       [['text'=>"𝙍𝙚𝙥𝙤𝙧𝙩 𝙋𝙧𝙤𝙗𝙡𝙚𝙢𝙨", 'url'=>"https://t.me/l_w_7"]],
                       ]
                       ])
                       ]);
